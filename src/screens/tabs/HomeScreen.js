...
function HomeScreen({ navigation }) {
    return (
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <TouchableOpacity style={styles.menuOption} onPress={() => navigation.navigate('Gathering')}>
          ...
          <TouchableOpacity style={styles.menuOption} onPress={() => navigation.navigate('Crafting')}>
          ...
          <TouchableOpacity style={styles.menuOption} onPress={() => navigation.navigate('Vendors')}>
          ...
          <TouchableOpacity style={styles.menuOption} onPress={() => navigation.navigate('WorldMap')}>
